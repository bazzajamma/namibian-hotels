...
/**
 * Maps amenity names to SVG icon components
 */
export function getAmenityIcon(amenity: string): React.ReactNode {
  const iconClass = "w-6 h-6 text-terracotta-500";
  ...
  if (normalized.includes('safari') || normalized.includes('tour')) {
    return (
      <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  if (normalized.includes('beach') || normalized.includes('coastal')) {
    return (
      <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  if (normalized.includes('game') || normalized.includes('wildlife')) {
    return (
      <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  if (normalized.includes('adventure') || normalized.includes('activity')) {
    return (
      <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
